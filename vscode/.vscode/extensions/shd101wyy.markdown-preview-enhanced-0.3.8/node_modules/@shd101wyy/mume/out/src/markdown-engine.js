...
const emoji_to_svg_1 = require("./render-enhancers/emoji-to-svg");
...
class MarkdownEngine {
    ...
    resetConfig() {
        ...
        this.config = Object.assign({}, markdown_engine_config_1.defaultMarkdownEngineConfig, (this.originalConfig || {}), (utility.configs.config || {}));
        this.initConfig();
    }
    /**
     * Set default values
    ...
    */
    ...
    generateScriptsForPreview(isForPresentation = false, yamlConfig = {}) {
        ...
        // jquery
        scripts += `<script type="text/javascript" src="file:///${path.resolve(utility.extensionDirectoryPath, "./dependencies/jquery/jquery.js")}" charset="UTF-8"></script>`;
        // jquery contextmenu
        scripts += `<script type="text/javascript" src="file:///${path.resolve(utility.extensionDirectoryPath, "./dependencies/jquery-contextmenu/jquery.ui.position.min.js")}" charset="UTF-8"></script>`;
        scripts += `<script type="text/javascript" src="file:///${path.resolve(utility.extensionDirectoryPath, "./dependencies/jquery-contextmenu/jquery.contextMenu.min.js")}" charset="UTF-8"></script>`;
        // jquery modal
        scripts += `<script type="text/javascript" src="file:///${path.resolve(utility.extensionDirectoryPath, "./dependencies/jquery-modal/jquery.modal.min.js")}" charset="UTF-8"></script>`;
        // crpto-js
        scripts += `<script type="text/javascript" src="file:///${path.resolve(utility.extensionDirectoryPath, "./dependencies/crypto-js/crypto-js.js")}" charset="UTF-8"></script>`;
        // mermaid
        scripts += `<script type="text/javascript" src="file:///${path.resolve(utility.extensionDirectoryPath, `./dependencies/mermaid/mermaid.min.js`)}" charset="UTF-8"></script>`;
        // wavedrome
        scripts += `<script type="text/javascript" src="file:///${path.resolve(utility.extensionDirectoryPath, "./dependencies/wavedrom/default.js")}" charset="UTF-8"></script>`;
        scripts += `<script type="text/javascript" src="file:///${path.resolve(utility.extensionDirectoryPath, "./dependencies/wavedrom/wavedrom.min.js")}" charset="UTF-8"></script>`;
        // math
        if (this.config.mathRenderingOption === "MathJax" ||
            ...
            scripts += `<script type="text/javascript" async src="file:///${path.resolve(utility.extensionDirectoryPath, "./dependencies/mathjax/MathJax.js")}" charset="UTF-8"></script>`;
...
if (typeof(window['Reveal']) !== 'undefined') {
  ...
  WaveDrom.ProcessAll()
        ...
        scripts += `<script src='file:///${path.resolve(utility.extensionDirectoryPath, "./dependencies/flowchart/flowchart.min.js")}'></script>`;
      ...
      for (var i = 0; i < flowcharts.length; i++) {
        ...
        scripts += `<script src="file:///${path.resolve(utility.extensionDirectoryPath, `./dependencies/vega/vega.min.js`)}" charset="UTF-8"></script>`;
        scripts += `<script src="file:///${path.resolve(utility.extensionDirectoryPath, `./dependencies/vega-lite/vega-lite.min.js`)}" charset="UTF-8"></script>`;
        scripts += `<script src="file:///${path.resolve(utility.extensionDirectoryPath, `./dependencies/vega-embed/vega-embed.min.js`)}" charset="UTF-8"></script>`;
        if (isForPresentation) {
            scripts += `<script>
    ...
    generateStylesForPreview(isPresentationMode = false, yamlConfig = {}) {
        ...
        if (!isPresentationMode) {
            ...
            styles += `<link rel="stylesheet" href="file:///${path.resolve(extensionDirectoryPath, `./styles/revealjs_theme/${yamlConfig["presentation"] &&
                typeof yamlConfig["presentation"] === "object" &&
                yamlConfig["presentation"]["theme"]
                ? yamlConfig["presentation"]["theme"]
                : this.config.revealjsTheme}`)}" >`;
    ...
    generateHTMLTemplateForExport(html, yamlConfig = {}, options) {
        ...
        `;
            ...
            if (html.indexOf(' class="mermaid') >= 0) {
                ...
                const mermaidConfig = yield utility.getMermaidConfig();
...
if (typeof(window['Reveal']) !== 'undefined') {
  ...
  mermaid.init(null, document.getElementsByClassName('mermaid'))
            ...
            if (html.indexOf(' class="vega') >= 0 ||
                ...
                if (options.offline) {
                    vegaScript += `<script type="text/javascript" src="file:///${path.resolve(utility.extensionDirectoryPath, `./dependencies/vega/vega.js`)}" charset="UTF-8"></script>`;
                    vegaScript += `<script type="text/javascript" src="file:///${path.resolve(utility.extensionDirectoryPath, `./dependencies/vega-lite/vega-lite.js`)}" charset="UTF-8"></script>`;
                    vegaScript += `<script type="text/javascript" src="file:///${path.resolve(utility.extensionDirectoryPath, `./dependencies/vega-embed/vega-embed.js`)}" charset="UTF-8"></script>`;
                }
                else {
...
for (var i = 0; i < flowcharts.length; i++) {
  ...
  try {
    ...
    flow.innerHTML = '<pre class="language-text">' + error.toString() + '</pre>'
      ...
      ${options.isForPrint
                    ? fs.readFileSync(path.resolve(extensionDirectoryPath, "./dependencies/reveal/pdf.css"))
                    : ""}
      </style>
      `;
      ...
      `;
            ...
            try {
                ...
                if (yamlConfig["isPresentationMode"]) {
                    styleCSS += yield utility.readFile(path.resolve(extensionDirectoryPath, `./styles/revealjs_theme/${yamlConfig["presentation"] &&
                        typeof yamlConfig["presentation"] === "object" &&
                        yamlConfig["presentation"]["theme"]
                        ? yamlConfig["presentation"]["theme"]
                        : this.config.revealjsTheme}`), { encoding: "utf-8" });
                }
                else {
                    // preview theme
                    styleCSS +=
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!puppeteer) {
                ...
                try {
                    ...
                    throw new Error("Puppeteer (Headless Chrome) is required to be installed globally. Please run `npm install -g puppeteer` in your terminal.  \n");
                }
            }
    ...
    */
    ...
    pandocRender(text = "", args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            args = [
                "-f",
                this.config.pandocMarkdownFlavor,
                "-t",
                "html",
                "--mathjax",
            ]
