 ...
 */
function processOutputConfig(config, args) {
    if (config['toc'])
        args.push('--toc');
    if (config['toc_depth'])
 ...
 */
function pandocConvert(text, { fileDirectoryPath, projectDirectoryPath, sourceFilePath, filesCache, protocolsWhiteListRegExp, /*deleteImages=true,*/ codeChunksData, graphsCache, imageDirectoryPath }, config = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { outputString, imagePaths } = yield process_graphs_1.processGraphs(text, { fileDirectoryPath, projectDirectoryPath, imageDirectoryPath, imageFilePrefix: md5(outputFilePath), useRelativeFilePath: true, codeChunksData, graphsCache });
