...
export declare function asCloseTextDocumentParams(textDocument: code.TextDocument): proto.TextDocumentIdentifier;
export declare function asTextDocumentIdentifier(textDocument: code.TextDocument): proto.TextDocumentIdentifier;
export declare function asTextDocumentPosition(textDocument: code.TextDocument, position: code.Position): proto.TextDocumentPosition;
