...
function activate(context) {
    ...
    const testResultDataProvidier = testRunner_1.buildTestProvider();
    ...
    vscode.commands.registerCommand('clojureVSCode.testNamespace', () => clojureEval_1.testNamespace(evaluationResultChannel, testResultDataProvidier));
    vscode.commands.registerCommand('clojureVSCode.runAllTests', () => clojureEval_1.runAllTests(evaluationResultChannel, testResultDataProvidier));
    ...
    vscode.languages.setLanguageConfiguration(clojureMode_1.CLOJURE_MODE.language, clojureConfiguration_1.ClojureLanguageConfiguration);
}
