...
const CLJ_EXPRESSION_DELIMITERS = new Map([
    [`}`, `{`],
    [`)`, `(`],
    [`]`, `[`],
    [CLJ_TEXT_DELIMITER, CLJ_TEXT_DELIMITER],
]);
const getExpressionInfo = (text) => {
...
const getRelativeExpressionInfo = (text, openChar = `(`) => {
    const relativeExpressionInfo = {
...
const containsValue = (map, checkValue) => {
...
//# sourceMappingURL=cljParser.js.map